...
public class SeleniumTest {
	...
	@Test
	public void searchForJstaSeAndKlickOnLink() throws InterruptedException, MalformedURLException{
		...
		driver.findElement(By.linkText("JS Testautomatisering - Sveriges bästa kurser")).click();
		driver.findElement(By.xpath("//*[contains(text(),'Kontakta oss')]"));
	...
	public void areAllElementsDisplayed(){
		...
		Assert.assertTrue(driver.findElement(By.linkText("Till valvet")).isDisplayed());
		Assert.assertTrue(driver.findElement(By.partialLinkText("valvet")).isDisplayed());
		Assert.assertTrue(driver.findElement(By.xpath("//input[@name='password']")).isDisplayed());
	}
	@Test
	public void verifyTextsOnLoginPage(){
		driver.get("http://localhost:8000");
		WebElement pageTitle = driver.findElement(By.tagName("h1"));
		WebElement loginButton = driver.findElements(By.tagName("input")).get(2);
		WebElement valvetButton = driver.findElement(By.tagName("a"));
	...
	public void compareSaldo(){
		...
		driver.findElement(By.linkText("Alla kunder")).click();
		String tableText = driver.findElement(By.xpath("//table")).getText();
		String customer = driver.findElement(By.xpath("//table//td")).getText();
		String customerSaldo = tableText.split(customer)[1].split("\n")[0];
		driver.findElement(By.linkText("Kolla saldo")).click();
		driver.findElement(By.id("name")).sendKeys(customer);
		driver.findElement(By.xpath("//input[@type='submit']")).click();
		float saldo = Float.valueOf(driver.findElement(By.xpath("//div[@class='bg-info']/p")).getText());
